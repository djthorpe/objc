 ...
 * This structure is used to store and manage selectors in the Objective-C runtime.
 */    
 ...
 * This function should be called before using the hash table to ensure it is ready for use.
 */    
void __objc_hash_init();

/*
 * Register a new selector in the hash table. This function adds a new method to the hash table, 
 * allowing it to be looked up later. Returns nil on failure, or a pointer to the newly registered 
 * hash item on success.
 */
