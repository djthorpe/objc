...
int main() {
  ...
  NXDate *newDate = [originalDate dateByAddingTimeInterval:1999 * Millisecond]; // ~2s
  ...
  BOOL success1 = [componentDate year:&year1 month:&month1 day:&day1 weekday:&weekday1];
  ...
  BOOL success2 = [componentDate year:&year2 month:&month2 day:&day2 weekday:&weekday2];
  ...
  NXTimeInterval largeDiff = 3 * Hour + 45 * Minute + 30 * Second + 750 * Millisecond;
