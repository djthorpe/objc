...
| NXFoundation_13 | Time Interval Operations | Tests NXTimeInterval constants, arithmetic, conversions, and string formatting. Includes time constants validation, mathematical operations, NXTimeIntervalMilliseconds conversion, negative interval handling, NXTimeIntervalDescription formatting with days/hours/minutes/seconds/milliseconds, and edge cases. |
...
| NXFoundation_18 | String Method Testing | Comprehensive NXString functionality tests. String creation, formatting, comparison, character operations, prefix/suffix checking, case conversion, appending methods, whitespace trimming, prefix/suffix trimming, substring searching, memory management, and edge cases. |
