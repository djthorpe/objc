 ...
 * @ingroup SystemDate
 * @deprecated Use sys_date_get_now() instead.
 ...
 * @ingroup SystemDate
 * @deprecated Use sys_date_get_time_utc() instead.
 ...
 * @ingroup SystemDate
 * @deprecated Use sys_date_get_date_utc() instead.
 ...
 * @ingroup SystemDate
 * @deprecated Use sys_date_set_time_utc() instead.
 ...
 * @ingroup SystemDate
 * @deprecated Use sys_date_set_date_utc() instead.
 * @param time Pointer to a sys_time_t structure to modify.
 ...
 * structures.
 * @ingroup SystemDate
 * @deprecated Use sys_date_compare_ns() instead.
 * @param start Pointer to the start time. If `NULL`, this is treated as
