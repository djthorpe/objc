...
const NXTimeInterval Millisecond = 1.0;

/** @brief 1 second = 1,000 milliseconds */
const NXTimeInterval Second = 1000.0 * Millisecond;

/** @brief 1 minute = 60,000 milliseconds */
const NXTimeInterval Minute = 60.0 * Second;

/** @brief 1 hour = 3,600,000 milliseconds */
const NXTimeInterval Hour = 60.0 * Minute;